...
WORDLIST_FILENAME = "F:/Projects/MITx Python/ps4_wordgame/words.txt"
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand): # As long as there are still letters left in the hand:
        print "Current Hand: ",
    ...
    if calculateHandlen(hand) > 0:
        print "Goodbye! Total score: " + str(total) + "points." # Game is over (user entered a '.' or ran out of letters), so tell user the total score
    else:
